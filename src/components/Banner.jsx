...
const Banner = () => {
  ...
  const toRotate = [ "Professionalism", "Dignity", "Integrity", "Patient", "Teamwork" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{'We Value'} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Professionalism", "Dignity", "Integrity", "Patient", "Teamwork" ]'><span className="wrap">{text}</span></span></h1>
